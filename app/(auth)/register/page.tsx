...
export default function RegisterPage() {
  const { form, onSubmit, onGitHubRegister, serverError, success, githubLoading } = useRegisterForm();
  ...
  return (
    <div ref={cardRef} className="w-full max-w-[400px] mx-auto px-5 py-8 sm:px-0">
      ...
      <p className="auth-sub mb-8 text-center text-sm text-[#6b6b6b] leading-relaxed">
        {success ? 'One last step before you start generating' : 'Start generating README files in seconds'}
      </p>
        ...
        <div className="p-6 sm:p-7">
          {success ? (
            <div className="flex flex-col items-center gap-4 py-4 text-center">
              ...
              <div>
                <p className="text-[15px] font-semibold text-[#f0f0f0] mb-1">Confirm your email</p>
